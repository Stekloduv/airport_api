...
class AdminRouteAPITests(TestCase):
    ...
    def test_route_create(self):
        ...
        try:
            ...
            self.fail(f"Route was not created. Response: {response.data}")

        self.assertEqual(data["source"], route.source.name)
        self.assertEqual(data["destination"], route.destination.name)
